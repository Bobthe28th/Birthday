...
import me.bobthe28th.birthday.games.minigames.bmsts.minions.entities.t2.GoatEntity;

public class GoatMinion extends Minion {
    public GoatMinion(Main plugin, Bmsts bmsts, BmTeam team, Rarity rarity, Integer strength) {
        super(plugin,bmsts, "Goat", GoatEntity.class, team, 2, rarity, strength, 18);
    }
}
