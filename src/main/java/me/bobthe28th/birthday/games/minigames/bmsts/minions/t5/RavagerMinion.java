...
import me.bobthe28th.birthday.games.minigames.bmsts.minions.entities.t5.RavagerEntity;

public class RavagerMinion extends Minion {

    public RavagerMinion(Main plugin, Bmsts bmsts, BmTeam team, Rarity rarity, Integer strength) {
        super(plugin,bmsts, "Ravager", RavagerEntity.class, team, 5, rarity, strength, 20);
    }
}
